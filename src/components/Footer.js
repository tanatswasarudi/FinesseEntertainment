        ...
        <div className="max-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2">
            ...
            <ul className="text-gray-500">
              ...
              <li className="pb-4"><span className="flex items-center flex-row hover:text-yellow-500"><Link to={'/booking'}></Link><BsChevronBarRight/>BOOKING</span> </li>
            ...
            <div className="mb-5">
              ...
              <li className="flex flex-row items-center hover:text-yellow-500 text-gray-500"><strong>Call:</strong><IoMdCall/> +263 783677124</li>
              </ul>
            </div>
          </div>
        </div>
        <div>
          <h4>Developed by: WEBTECH</h4>
          <p className="flex flex-row items-center font-sans text-gray-500"><MdEmail/><strong>Email:</strong>tanatswasarudi09@gmail.com</p>
        </div>
      </div>
    </footer>
  );
